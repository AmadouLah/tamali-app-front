...
export const routes: Routes = [
  ...
  {
    path: 'dashboard/business/exports',
    loadComponent: () => import('./pages/dashboard/business/exports/business-exports.component').then(m => m.BusinessExportsComponent)
  },
  {
  ...
  {
    path: 'dashboard/business/categories',
    loadComponent: () => import('./pages/dashboard/business/categories/business-categories.component').then(m => m.BusinessCategoriesComponent)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/dashboard/business/profile/business-profile.component').then(m => m.BusinessProfileComponent)
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import('./pages/dashboard/admin/users/users.component').then(m => m.UsersComponent)
  },
  {
  ...
  {
    path: 'dashboard/admin/instant-notifications',
    loadComponent: () =>
      import('./pages/dashboard/admin/instant-notifications/instant-notifications.component').then(m => m.InstantNotificationsComponent)
  }
];
