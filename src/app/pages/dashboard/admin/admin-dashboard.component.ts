...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, GlassCardComponent, AdminSidebarComponent, AnnouncementBannerComponent],
...
export class AdminDashboardComponent implements OnInit {
  ...
  private updateActiveMenuFromRoute(): void {
    ...
    else if (currentRoute.includes('instant-notifications')) this.activeMenu = 'notifications instantanées';
